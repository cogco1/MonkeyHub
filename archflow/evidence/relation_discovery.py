...
This is realized-contact discovery evidence only.  Its candidates and ledger
do not define relationship requirements, prove missing required relations, or
carry stage-closure authority.
"""
