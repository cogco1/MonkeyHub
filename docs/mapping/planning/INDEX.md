...
| --- | --- | --- | --- | --- |
| P026 | planning | ready | Prove one true raw-request-to-usable-building run as a reloadable accepted platform-neutral sandbox artifact. | [P026](P026-sandbox-prompt-to-usable-gold.md) |
| P027 | planning | ready | Extend the accepted sandbox slice to uneven site geometry without a fixed site-response answer. | [P027](P027-uneven-terrain-adaptation.md) |
