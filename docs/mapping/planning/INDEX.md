...
| GH-292 | active | Prevent automatic retained model thumbnails from mutating the Board; preserve explicit image placement. | [GH-292](https://github.com/cogco1/MonkeyHub/issues/292) |
| GH-289 | active | Integrate candidate disposition and attributed endorsement from GH-289 and GH-290, including concurrent writes and branch history. | [GH-289](https://github.com/cogco1/MonkeyHub/issues/289) |
| GH-282 | active | Open the existing Hub display settings from the Fab empty state and verify the actual navigation. | [GH-282](https://github.com/cogco1/MonkeyHub/issues/282) |
| GH-255 | active | Integrate repeated external-model ingestion measurements; keep real-model and first-frame acceptance open. | [GH-255](https://github.com/cogco1/MonkeyHub/issues/255) |
| GH-327 | active | Retain GLB to 3DM duplicate-corner normals and black-material round-trip regression. | [GH-327](https://github.com/cogco1/MonkeyHub/issues/327) |
| GH-268 | active | Integrate the bounded sequential OCBA rollout experiment without claiming live Harness performance gains. | [GH-268](https://github.com/cogco1/MonkeyHub/issues/268) |
| GH-122 | active | Preserve retrieval evidence identity and missing exception details in the offline benchmark. | [GH-122](https://github.com/cogco1/MonkeyHub/issues/122) |
