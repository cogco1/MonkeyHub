...
Status: review under `GH-122/retrieval-lab`. Human relevance review is still
required before the next experiment. Parent issue:
...
default. No reviewer identity or approval is supplied, so the next default-selection experiment remains
