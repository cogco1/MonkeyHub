...
- [ ] **C11｜校准过时 P 卡文字（本轮相关部分完成）。** 已更新 P111 的 Program／options 来源限制，移除 P108 的旧重建清单和“尚无候选”快照，并将重复整理清单归到本卡。2026-09-08 已同步 P110／P111／P113 的具体等待条件及 P114 的源码交接状态；P105 的旧能力枚举仍待实际消费者核对；本轮不关闭原功能验收，也不将尚未核对的卡标成完成。
