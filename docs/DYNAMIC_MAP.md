...
- next: continue active work: GH-294, GH-66

## Live work

| ID | Status | Goal | Card |
| --- | --- | --- | --- |
| GH-294 | active | Audit where candidate-like execution runs are created, retained and surfaced, and propose the minimum seam so only admitted design results become architectural Candidates. | [GH-294](mapping/planning/GH-294-candidate-admission.md) |
