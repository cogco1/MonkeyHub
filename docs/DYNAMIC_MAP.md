...
| GH-314 | active | Remove unchanged heartbeat snapshot reconstruction and operation-history copies from the Hub project watcher, preserving work-copy observation, external refresh and recovery responsiveness. | [GH-314](https://github.com/cogco1/MonkeyHub/issues/314) |
