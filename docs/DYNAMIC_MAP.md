...
Phase: The ArchFlow/MonkeyArch/MonkeyDiagram source separation is implemented and verified in the isolated migration branch, with the prior source snapshot retained in Git. The frozen v0.1.0 source candidate is unchanged. P115 retains only the broader unchecked consolidation work; existing feature cards resume from the migrated source when their work continues. No private project or active application was changed.

- active: P115
- ready: none
- blocked: P094, P105, P108, P110, P111, P113, P114
...
| ID | Status | Goal | Card |
| --- | --- | --- | --- |
| P115 | active | Consolidate existing capabilities under the shared ArchFlow core, MonkeyArch 3D and MonkeyDiagram drawing owners. The physical workflow migration is implemented; remaining unchecked consolidation items stay on the existing card and follow the next concrete consumer. | [P115](mapping/planning/P115-capability-consolidation.md) |
| P094 | blocked | Prepare the CAADRIA 2027 full paper from the author-designated current Chinese abstract and retained records: Chinese working draft first, then an English manuscript in the applicable official template. The author selects the contribution and empirical scope; every quantitative claim resolves to its retained source. Paper work is currently paused. | [P094](mapping/planning/P094-caadria-2027-manuscript.md) |
