...
- active: GH-294, GH-284, GH-66
- ready: none
- blocked: P115, P105, P108, P110, P111, P113
- next: continue active work: GH-294, GH-284, GH-66

## Live work

| ID | Status | Goal | Card |
| --- | --- | --- | --- |
| GH-294 | active | Record the repository owner's decisions on the candidate admission seam so implementation slice S1 can start. | [GH-294](mapping/planning/GH-294-candidate-admission.md) |
...
| GH-284 | active | Show the Design Tree prototype as an explicit bracket of branches: each Study's options converge on the continued one, solid for the continued path and dashed for the rest. | [GH-284](mapping/planning/GH-284-candidate-graph.md) |
