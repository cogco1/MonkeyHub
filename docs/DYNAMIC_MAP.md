...
- next: continue active work: GH-66, GH-291
...
| GH-291 | active | Close drawing revision replacement gaps: exact before/after identity on restoration, idempotent retries, conflicting stale rebuild refusal and persisted consumer regressions. | [GH-291](https://github.com/cogco1/MonkeyHub/issues/291) |
