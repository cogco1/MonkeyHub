...
- next: continue active work: GH-66, GH-292
...
| GH-292 | active | Retain exact-source viewport model previews through existing SourceDocument/P036 and show them in the mounted design history and candidate consumers. | [GH-292](https://github.com/cogco1/MonkeyHub/issues/292) |
