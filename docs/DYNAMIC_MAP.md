...
- next: continue active work: GH-302, GH-66
...
| GH-302 | active | Land the P0 follow-ups of the 2026-09-25 UX review outside GH-66's files: agent results never take the view, viewing never moves the editing base, Sync becomes Record with one-click record-and-continue, one Board vocabulary, autosave instead of Save buttons in Hub settings and Drawing, the canvas zoom bar stays inside its surface, and the parallel history entries retire behind the Design Tree. | [GH-302](mapping/planning/GH-302-review-p0.md) |
