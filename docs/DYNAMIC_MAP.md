...
- active: GH-223, GH-291, GH-303, GH-66
- ready: none
- blocked: P115, P105, P108, P110, P111, P113
- next: continue active work: GH-223, GH-291, GH-303, GH-66
...
| GH-223 | active | Correction capture reaches drawing production: a new drawing takes the project's accepted drawing recipe, below an explicit value and the drawing's own previous revision. | [GH-223](mapping/planning/GH-223-correction-capture.md) |
| GH-291 | active | Render follows a rebuilt drawing through its registered replacement instead of its own front-end fallback. | [GH-291](mapping/planning/GH-291-render-consumers.md) |
| GH-303 | active | The Hub Agent reviews visually through one bounded tool: visual_review calls the runtime route under a per-turn budget the Hub holds, returns findings rather than images, and is traced as visual_observation; the Agent can also place drawing dressing through studio_request. | [GH-303](mapping/planning/GH-303-hub-agent.md) |
