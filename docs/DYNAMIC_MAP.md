...
- active: GH-319, GH-244, GH-66
- ready: none
- blocked: P115, P105, P108, P110, P111, P113
- next: continue active work: GH-319, GH-244, GH-66
...
| GH-319 | active | A model converted from GLB to 3DM displays correctly: the production conversion keeps or computes normals for the actual topology, keeps faces consistently wound, gives a neutral fallback colour to a mesh without material, keeps the source attributes it can, and says what it did. | [GH-319](mapping/planning/GH-319-model-normals.md) |
| GH-244 | active | Drawing cleanup and section perspectives catch up with cut plans: a cut line lying on another object's cut line is drawn once, the cleanup report names the objects each rule touched, and a section perspective takes material hatch, poché and beyond fade like a cut plan. | [GH-244](mapping/planning/GH-244-cleanup-and-section-graphics.md) |
