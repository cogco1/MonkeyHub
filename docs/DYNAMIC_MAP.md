...
| GH-284 | active | Research external version and alternative interactions and prototype a project-level Candidate Graph that shows Stage, Study, admitted Candidates, Continue and the next Stage. | [GH-284](mapping/planning/GH-284-candidate-graph.md) |
