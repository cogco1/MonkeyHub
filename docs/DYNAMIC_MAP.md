...
| GH-284 | active | Ship the first product Design Tree: a Stage chip in the project workspace header opens a growth tree of Stages, admitted Candidates and running Agent work on the canvas shared with MonkeyBoard, with View, Continue and Accept kept distinct. | [GH-284](mapping/planning/GH-284-design-tree-ui.md) |
