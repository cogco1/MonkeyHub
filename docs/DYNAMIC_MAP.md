...
| GH-302 | active | End the one changed DocumentCanvas.css line with LF so the CI whitespace check passes for batch C (#308). | [GH-302](mapping/planning/GH-302-review-p0.md) |
