...
- active: GH-223, GH-244, GH-66
- ready: none
- blocked: P115, P105, P108, P110, P111, P113
- next: continue active work: GH-223, GH-244, GH-66
...
| GH-223 | active | Drawing corrections become evidence the system can read: each revision says whether a person or the Agent asked for it, a read-only projection classifies adjacent revisions, and repeated human corrections across drawings are offered as a project recipe. | [GH-223](mapping/planning/GH-223-drawing-corrections.md) |
| GH-244 | active | The Drawing canvas shows what each projected line is and lets the architect keep a correction: lines are selectable with their component, material and role, a hidden object stays hidden, untouched pens let the project recipe apply, and a repeated correction can be saved as a project recipe. | [GH-244](mapping/planning/GH-244-drawing-canvas.md) |
