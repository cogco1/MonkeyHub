...
- next: continue active work: GH-66, GH-295
...
| GH-295 | active | Present Drawing as a project Tool beside Monitor instead of a peer of Arch and Diagram, preserving project context and return navigation. | [GH-295](mapping/planning/GH-295-drawing-tools.md) |
