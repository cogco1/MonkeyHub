...
6. **Budget.** On the two ordinary plans the look cost about 19 k tokens and 17–27 s to confirm what the exact checks could not judge. On the over-dressed plan the first look was the only source of the density and balance findings; its entourage finding overlapped what the exact collision check already knew.
