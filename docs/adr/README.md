...
One file per decision a later session would be tempted to reverse. Ten lines each: decision, why, do-not.

- [ADR-001-one-spine](ADR-001-one-spine.md)
- [ADR-002-rhino-is-not-the-source-of-truth](ADR-002-rhino-is-not-the-source-of-truth.md)
- [ADR-003-two-identities](ADR-003-two-identities.md)
