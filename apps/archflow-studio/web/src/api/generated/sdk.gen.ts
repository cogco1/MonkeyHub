 ...
 * Shared Manifest
 */
export const sharedManifestApiSyncManifestGet = <ThrowOnError extends boolean = false>(options?: Options<SharedManifestApiSyncManifestGetData, ThrowOnError>): RequestResult<SharedManifestApiSyncManifestGetResponses, unknown, ThrowOnError> => (options?.client ?? client).get<SharedManifestApiSyncManifestGetResponses, unknown, ThrowOnError>({ url: '/api/sync/manifest', ...options });
