...
function createPage(scope: DocumentAnnotationsOptions) {
...
export function createDocumentAnnotationsController() {
...
export function useDocumentAnnotations(
  ...
  const [localController] = useState(createDocumentAnnotationsController);
