...
import {UserPreferencesProvider,usePreferences} from '/src/features/settings/preferences';
...
`;
const server = await createServer({ root, configFile: false, publicDir: false, logLevel: "error", cacheDir: join(screenshots, "vite"),
