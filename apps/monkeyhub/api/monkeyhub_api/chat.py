...
def _mcp(hub: str, chat_id: str | None, external: ChatPresentationBindRequest | None = None) -> None:
    ...
    modelling = chr(10).join([
        ...
        "A prepared ContextPack already supplies facts for its exact source/task/focus. Reuse covered facts and its request template; supplement missing facts instead of repeating discovery reads.",
        ...
        "The numeric reply's target/change/kept already describe the checked proposal. Read the proposal only for additional details the task needs.",
        "A prepared ContextPack remains evidence of the BEFORE state after execution. Compare needed candidate authored fields with those covered facts; do not reread the same before source just to obtain them again.",
        ...
        "Refresh context for a new edit/task, changed scope/source or retained feedback. Finishing observation of an already executed change does not itself require a new ContextPack; retain necessary candidate-state and visual checks.",
