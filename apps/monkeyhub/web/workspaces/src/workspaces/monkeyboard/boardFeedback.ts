...
export async function prepareBoardDesignRequest(studio: StudioClient, selection: BoardFeedbackSelection, projectId: string, comment: string): Promise<BoardDesignRequest> {
