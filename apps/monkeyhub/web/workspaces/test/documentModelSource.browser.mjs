...
function App(){
 ...
 const [editing,setEditing]=useState(modelB),[controller]=useState(()=>{Object.assign(studio,overrides);return createDocumentAnnotationsController(studio)}),
...
`;
const server = await createServer({ root, configFile: false, resolve: { dedupe: ["react", "react-dom"] }, logLevel: "error", publicDir: false,
