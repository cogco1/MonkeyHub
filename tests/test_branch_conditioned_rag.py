...
from archflow.capabilities import branch_research as legacy_branch_research
from archflow.research import branch as canonical_branch_research
...
from archflow.capabilities.precedent import PrecedentAdoption, PrecedentFact
...
from archflow.runtime.branch_portfolio import BranchPortfolioArchive
from archflow.runtime.architectural_revision import (
    ArchitecturalRevisionError,
    _portfolio_uses_branch_research_selection,
    _require_branch_index_matches_selected_predecessor,
)
from archflow.runtime.branch_research import (
...
from tests.test_semantic_spatial_authoring import (
    _ScriptedProvider,
    _semantic_proposal,
)
...
class BranchScopeTests(unittest.TestCase):
    ...
    def test_typed_snapshot_checks_requested_and_final_redirect_urls(self):
        *_, scope = _selected_scope()
        ...
        with patch(
            "archflow.adapters.web_evidence.urllib.request.urlopen",
