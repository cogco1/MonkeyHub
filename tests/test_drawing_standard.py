...
from archflow.documentation.drawings import compile_drawing_state, validate_drawing_state
...
class DrawingStandardTests(unittest.TestCase):
    def setUp(self):
        config = Path(__file__).resolve().parents[1] / "archflow" / "documentation" / "drawing_standard_v0_1.json"
