...
in :mod:`archive.archflow.capabilities.stage_evidence_pack` and :mod:`archflow.project`.
"""
...
try:  # Package import in tests; direct import when executed as a script.
    from archive.tools import parthenon_stage4_correction_records as stage4_corrections
    from archive.tools import parthenon_stage4_doors as stage4_doors
    from archive.tools import parthenon_stage4_inner_colonnade as stage4_inner_colonnade
    from archive.tools import parthenon_stage4_relation_contracts as stage4_relation_contracts
    from archive.tools import parthenon_stage4_relations as stage4_relations
    from archive.tools import parthenon_stage4_roof as stage4_roof
...
from archive.archflow.adapters.three_dm_witness import (
    add_axis_aligned_box_brep_witnesses,
    primary_three_dm_objects,
)
from archive.archflow.capabilities.stage_evidence_pack import (
...
from archive.archflow.capabilities.stage_component_coverage import (
...
from archflow.project.refs import BranchRef, ProjectArtifactRef, ProjectRecordRef, ProjectVersionRef, RunRef
