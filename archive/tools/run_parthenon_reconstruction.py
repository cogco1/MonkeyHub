...
try:  # Package import in tests; direct import when executed as a script.
    from archive.tools._probe_paths import WORKSPACE_PROJECTS
...
from archive.archflow.capabilities.branch_research import (
    BranchResearchScope,
    DecisionResearchNeed,
    bind_branch_snapshot,
    compile_branch_query,
)
from archive.archflow.capabilities.architectural_completeness import (
...
from archive.archflow.capabilities.spatial_validation import (
    AABB,
    HostRegion,
    OpeningClearRegion,
    SpatialElement,
...
from archflow.project.refs import BranchRef, ProjectArtifactRef, ProjectRecordRef, RunRef
