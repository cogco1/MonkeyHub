...
Usage:
    python archive/tools/state_tree_viewer.py <projects-root> [--port 8766]
    python archive/tools/state_tree_viewer.py <projects-root> \
...
from archive.archflow.contracts.reading import read_key_diagnostics  # noqa: E402
from archive.archflow.capabilities.stage_evidence_pack import (  # noqa: E402
    STAGE_EVIDENCE_PACK_KEYS,
)
from archive.tools.build_pantheon_progress_snapshot import (  # noqa: E402
...
def _typed_stage_pack(payload: object) -> tuple[dict[str, object], bool]:
    ...
    module_name = "archive.archflow.capabilities.stage_evidence_pack"
    try:
