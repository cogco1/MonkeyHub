...
def _persist_verified_stage_artifact_claim(
    ...
    *,
    ...
    from archive.tests.integration.test_stage_control_runtime import (
    ...
    from archive.tests.test_stage_control_runtime import (
    ...
    with patch(
        "archive.tests.test_stage_control_runtime._stair_sources",
        return_value=(base_proposal, component_index, branch),
    ), patch(
        "archive.tests.test_stage_control_runtime._record_ref",
