...
from archive.archflow.runtime.commitment_compiler import (
    IntentObservation,
    IntentOperator,
    IntentTerm,
    compile_intent,
...
from archive.archflow.validation.assembly import RelationshipKind, check_assembly
...
class NestedDesignStateTests(unittest.TestCase):
    ...
    def test_phase_change_refreshes_phase_conditioned_readiness(
        ...
        from archive.archflow.state.design_state import compile_tree_phase_change
