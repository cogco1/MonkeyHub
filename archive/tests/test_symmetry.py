...
from archive.archflow.evaluation.symmetry import SymmetryMeasurementError, axial_group_offsets
...
class DerivedRowOriginTest(unittest.TestCase):
    def test_monument_rows_center_on_the_axis(self):
        from archive.tools.projects.pantheon.monument_support import (
            CENTER_X,
            _axial_row_origin,
        )
