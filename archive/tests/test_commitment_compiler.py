...
import archive.archflow.compilers.commitments as canonical_commitments
import archive.archflow.runtime.commitment_compiler as legacy_commitments
...
from archflow.state.commitments import CommitmentAuthorityError, CommitmentStatus, CommitmentStrength
...
class CommitmentCompilerTests(unittest.TestCase):
    ...
    def test_compiler_has_no_pack_or_building_specific_default(self) -> None:
        source = (
            __import__(
                "archive.archflow.compilers.commitments",
                fromlist=["__file__"],
            )
            .__file__
        )
